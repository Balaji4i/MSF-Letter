...
import model.ro.Lookup_Values_ROVOImpl;
import model.ro.Loopup_Types_ROVOImpl;

import model.vo.DutyAllowanceLinesVoImpl;
import model.vo.DutyAllowance_VOImpl;


import model.vo.MsfLetter_VOImpl;
...
//
    ...
    public void filterUser() {
        //ADFContext.getCurrent().getSessionScope().put("userName", "PApanpa");
        String userName= ADFContext.getCurrent()
                                    .getSessionScope()
                                    .get("userName")
                                    .toString();
        System.err.println(userName + "--------------User Name");
        ViewObjectImpl vo = getMsfLetter_VO();
    ...
    /**
     * Container's getter for MsfLetter_VO1.
     * @return MsfLetter_VO1
     */
    public MsfLetter_VOImpl getMsfLetter_VO() {
        return (MsfLetter_VOImpl) findViewObject("MsfLetter_VO");
    }

    /**
     * Container's getter for Loopup_Types_ROVO1.
     * @return Loopup_Types_ROVO1
     */
    public Loopup_Types_ROVOImpl getLoopup_Types_ROVO() {
        return (Loopup_Types_ROVOImpl) findViewObject("Loopup_Types_ROVO");
    }

    /**
     * Container's getter for Lookup_Values_ROVO1.
     * @return Lookup_Values_ROVO1
     */
    public Lookup_Values_ROVOImpl getLookup_Values_ROVO() {
        return (Lookup_Values_ROVOImpl) findViewObject("Lookup_Values_ROVO");
    }
}
