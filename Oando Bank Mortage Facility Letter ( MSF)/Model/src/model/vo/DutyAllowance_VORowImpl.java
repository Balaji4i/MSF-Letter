...
public class DutyAllowance_VORowImpl extends ViewRowImpl {
    ...
    public static final int DUTYALLOWANCELINESVO = AttributesEnum.DutyAllowanceLinesVo.index();
...
//        }
    ...
    /**
     * Gets the attribute value for the calculated attribute PreviousApprover.
     * @return the PreviousApprover
     */
    ...
    /**
     * Gets the attribute value for the calculated attribute NextApprover.
    ...
    /**
     * Gets the associated <code>RowIterator</code> using master-detail link DutyAllowanceLinesVo.
     */
    public RowIterator getDutyAllowanceLinesVo() {
        return (RowIterator) getAttributeInternal(DUTYALLOWANCELINESVO);
    }

    /**
     * Gets the attribute value for TOT_ALLOWANCE_AMOUNT using the alias name TotAllowanceAmount.
     * @return the TOT_ALLOWANCE_AMOUNT
     */
    public BigDecimal getTotAllowanceAmount() {
        BigDecimal totVal = new BigDecimal(0);
        RowIterator rs = getDutyAllowanceLinesVo();
        while (rs.hasNext()) {
         Row r = rs.next();
            totVal = totVal.add(r.getAttribute("AllowanceAmount")==null ?new BigDecimal(0) :(BigDecimal) r.getAttribute("AllowanceAmount"));
        }
        return totVal;
//        else{
//        
...
//    }
    ...
    /**
     * Sets <code>value</code> as attribute value for TOT_ALLOWANCE_AMOUNT using the alias name TotAllowanceAmount.
     * @param value value to set the TOT_ALLOWANCE_AMOUNT
     */
